...
var boundHeight = 48;
var characters = [];
var kyznecImg = new Image();
kyznecImg.src = './img/kyznec/Idle.png';
var stranijImg = new Image();
stranijImg.src = './img/stranij/Idle.png';
var koshatnikImg = new Image();
  ...
  row.forEach(function (symbol, j) {
    if (symbol === 424) {
      ...
      characters.push(new Character({
        ...
        image: itemImg,
        scale: 1,
        dialogue: ['Вы подняли ветки дерева']
      }));
    } else if (symbol === 422) {
      characters.push(new Character({
        position: {
